...
const navigationByRole: Record<UserRole, { label: string; href: string; icon: React.ReactNode }[]> = {
  ADMIN: [
    { label: 'Dashboard', href: '/dashboard', icon: <LayoutDashboard className="w-5 h-5" /> },
    { label: 'Users', href: '/dashboard/users', icon: <Users className="w-5 h-5" /> },
    { label: 'Projects', href: '/dashboard/projects', icon: <FolderOpen className="w-5 h-5" /> },
    { label: 'Tasks', href: '/dashboard/tasks', icon: <CheckSquare className="w-5 h-5" /> },
  ],
  PROJECT_MANAGER: [
    { label: 'Dashboard', href: '/dashboard', icon: <LayoutDashboard className="w-5 h-5" /> },
    { label: 'My Projects', href: '/dashboard/projects', icon: <FolderOpen className="w-5 h-5" /> },
    { label: 'Tasks', href: '/dashboard/tasks', icon: <CheckSquare className="w-5 h-5" /> },
  ],
  TEAM_MEMBER: [
    { label: 'Dashboard', href: '/dashboard', icon: <LayoutDashboard className="w-5 h-5" /> },
    { label: 'My Projects', href: '/dashboard/projects', icon: <FolderOpen className="w-5 h-5" /> },
    { label: 'My Tasks', href: '/dashboard/tasks', icon: <CheckSquare className="w-5 h-5" /> },
  ],
}
